...
export default function AdminPage() {
  ...
  function renderSourcePreview(source: Source, key: string, className: string, previewClassName: string) {
    const sourceContent = (
      <>
        <p className="font-semibold text-sky-700 dark:text-sky-200">{source.document_name} · {source.location}</p>
        <MarkdownView content={source.preview} className={previewClassName} inline />
      </>
    );
